...
pathC = os.path.join("/home/yinzi/data3/new_train/checkpoints_C/cec0face", "best.pth.tar")
...
for batch in dataloader['test']:
    ...
    for k in range(final_pred.shape[0]):
        ...
        os.makedirs("/home/yinzi/data3/celeb_ABC_pred_no_end2end_out", exist_ok=True)
        os.makedirs("/home/yinzi/data3/celeb_ABC_out_no_end2end_gt", exist_ok=True)
        final_out.save("/home/yinzi/data3/celeb_ABC_pred_no_end2end_out/%s.png" % names[k], format="PNG", compress_level=0)
        orig_out.save("/home/yinzi/data3/celeb_ABC_out_no_end2end_gt/%s.png" % names[k], format="PNG", compress_level=0)
