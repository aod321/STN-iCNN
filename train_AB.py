...
parser.add_argument("--lr", default=1e-2, type=float, help="Learning rate for optimizer1")
parser.add_argument("--lr_s", default=1e-2, type=float, help="Learning rate for optimizer_select")
