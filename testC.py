...
from helper_funcs import F1Score, calc_centroid, affine_crop, affine_mapback, stage2_pred_onehot
import numpy as np
import torch
...
for epoch in range(Times):
    ...
    for batch in dataloader['test']:
        ...
        onehot_stage2 = stage2_pred_onehot(stage2_pred)
        # imshow predict
        # for i in range(6):
        ...
        final_pred = affine_mapback(onehot_stage2, theta, device)
